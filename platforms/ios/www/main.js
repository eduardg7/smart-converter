...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"], _modal_modal_component__WEBPACK_IMPORTED_MODULE_10__["ModalComponent"]],
            entryComponents: [_modal_modal_component__WEBPACK_IMPORTED_MODULE_10__["ModalComponent"]],
...
module.exports = "<ion-header>\n\t<ion-toolbar>\n\t\t<ion-title>\n\t\t\t{{units[index].converter}}\n\t\t</ion-title>\n\t</ion-toolbar>\n</ion-header>\n<ion-content>\n\t<ion-list>\n\t\t<ion-radio-group>\n\t\t\t<ion-list-header>\n\t\t\t\t<ion-label>Choose measurement unit:</ion-label>\n\t\t\t</ion-list-header>\n\t\t\t<ion-item *ngFor=\"let choice of units[index].choices\">\n\t\t\t\t<ion-label>{{choice}}</ion-label>\n\t\t\t\t<ion-radio slot=\"end\" (ionSelect)=\"dismissModal(choice, type)\" color=\"light\"></ion-radio>\n\t\t\t</ion-item>\n\t\t</ion-radio-group>\n\t</ion-list>\n</ion-content>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _services_conversion_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/conversion.service */ "./src/app/services/conversion.service.ts");




var ModalComponent = /** @class */ (function () {
    function ModalComponent(modalController, navParams, conversionService) {
    ...
    ModalComponent.prototype.ionViewWillEnter = function () {
        this.index = this.navParams.get('index');
        this.type = this.navParams.get('type');
    };
    ModalComponent.prototype.dismissModal = function (choice, type) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.modalController.dismiss(this.result)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ModalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            providers: [_services_conversion_service__WEBPACK_IMPORTED_MODULE_3__["ConversionService"]],
            styles: [__webpack_require__(/*! ./modal.component.scss */ "./src/app/modal/modal.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"], _services_conversion_service__WEBPACK_IMPORTED_MODULE_3__["ConversionService"]])
    ], ModalComponent);
...
/***/ "./src/app/services/conversion.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/conversion.service.ts ***!
  \************************************************/
...
var ConversionService = /** @class */ (function () {
    function ConversionService(_http) {
        this._http = _http;
    }
    ConversionService.prototype.getUnits = function () {
        return this._http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urls.UNITS_URL).pipe(function (response) {
            return response;
        });
    };
    ConversionService.prototype.getConversions = function () {
        return this._http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].urls.CONVERSIONS_URL).pipe(function (response) {
            return response;
        });
    };
...
module.exports = __webpack_require__(/*! /Users/adriansandu/smart-converter/src/main.ts */"./src/main.ts");
